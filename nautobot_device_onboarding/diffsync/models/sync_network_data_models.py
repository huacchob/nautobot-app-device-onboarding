...
class SyncNetworkModuleBay(DiffSyncModel):
    ...
    @classmethod
    def create(cls, adapter: "Adapter", ids: dict, attrs: dict) -> Optional["SyncNetworkModuleBay"]:
...
class SyncNetworkModuleType(DiffSyncModel):
    ...
    @classmethod
    def create(cls, adapter: "Adapter", ids: dict, attrs: dict) -> Optional["SyncNetworkModuleType"]:
...
class SyncNetworkModule(DiffSyncModel):
    ...
    @classmethod
    def create(cls, adapter: "Adapter", ids: dict, attrs: dict) -> Optional["SyncNetworkModule"]:
        """Create a new module."""
        try:
        ...
        try:
            ...
            adapter.job.logger.error(f"Module failed to create, {err}")
            raise diffsync_exceptions.ObjectNotCreated
